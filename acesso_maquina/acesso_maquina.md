...
![Acesso a Mica](/imagens/acesso_mica.png)
...
![Remote SSH](/imagens/remote_ssh.png)

1. Acesse o arquivo de configuração ('config') do ssh. Ele pode ser acessado da seguinte forma:

![Explorador Remoto](/imagens/explorador_remoto.png)

![Selecionar Arquivo](/imagens/selecionar_arquivo.png)

1. Edite o arquivo de configuração da seguinte forma:

![Arquivo de Config](/imagens/arquivo_config.png)
